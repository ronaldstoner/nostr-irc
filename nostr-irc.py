...
def main(stdscr):
    ...
    asyncio.run(main_task(relay, status_bar, my_pubkey, time_since, messages, client_uuid, friendlist))


# asyncio task gather and handler
async def main_task(relay, status_bar, my_pubkey, time_since, messages, client_uuid, friendlist):
    tasks = [
